...
[p]
この汽車は新橋を昨夜九時半に発って、今夕敦賀に入ろうという、名古屋では正午だったから、飯に一折の鮨を買った。
[p]
...
[p]
すると上人は頷いて、私は中年から仰向けに枕に就かぬのが癖で、寝るにもこのままではあるけれども目はまだなかなか冴えている、急に寐就かれないのはお前様とおんなじであろう。
[p]
出家のいうことでも、教だの、戒だの、説法とばかりは限らぬ、若いの、聞かっしゃい、と言って語り出した。後で聞くと宗門名誉の説教師で、六明寺の宗朝という大和尚であったそうな。
[p]
[jump target="ch3"]
...
[p]
ここに居て、さっきから休んでござったのが、右の売薬じゃ。このまた万金丹の下廻と来た日には、ご存じの通り、千筋の単衣に小倉の帯、当節は時計を挟んでいます、脚絆、股引、これはもちろん、草鞋がけ、千草木綿の風呂敷包の角ばったのを首に結えて、桐油合羽を小さく畳んでこいつを真田紐で右の包につけるか、小弁慶の木綿の蝙蝠傘を一本、おきまりだね。
[p]
...
ポンと煙管を払いて、
[p]
（何、遠慮をしねえで浴びるほどやんなせえ、生命が危くなりゃ、薬を遣らあ、そのために私がついてるんだぜ、なあ姉さん。
[p]
おい、それだっても無銭じゃあいけねえよ、憚りながら神方万金丹、一貼三百だ、欲しくば買いな、まだ坊主に報捨をするような罪は造らねえ、それともどうだお前いうことを肯くか。
[p]
）といって茶店の女の背中を叩いた。
[p]
私はそうそうに遁出した。
...
[p]
上を見ながら、これへ足を踏懸けた時、以前の薬売がすたすたやって来て追着いたが。
[p]
...
[p]
売薬は先へ下りたが立停ってしきりに四辺を※(「目＋句」、第4水準2-81-91)している様子、執念深く何か巧んだかと、快からず続いたが、さてよく見ると仔細があるわい。
[p]
...
[p]
ご坊様歩行きながらお念仏でも唱えてやってくれさっしゃい。）と問わぬことまで深切に話します。それでよく仔細が解って確になりはなったけれども、現に一人踏迷った者がある。
[p]
（こちらの道はこりゃどこへ行くので、）といって売薬の入った左手の坂を尋ねて見た。
[p]
（はい、これは五十年ばかり前までは人が歩行いた旧道でがす。やっぱり信州へ出まする、先は一つで七里ばかり総体近うござりますが、いや今時往来の出来るのじゃあござりませぬ。
[p]
去年もご坊様、親子連の巡礼が間違えて入ったというで、はれ大変な、乞食を見たような者じゃというて、人命に代りはねえ、追かけて助けべえと、巡査様が三人、村の者が十二人、一組になってこれから押登って、やっと連れて戻ったくらいでがす。
[p]
...
[p]
罷違うて旧道を皆歩行いても怪しゅうはあるまい、こういう時候じゃ、狼の旬でもなく、魑魅魍魎の汐さきでもない、ままよ、と思うて、見送ると早や深切な百姓の姿も見えぬ。
[p]
（よし。）
[p]
...
[p]
歩行くにはこの方が心細い、あたりがぱッとしていると便がないよ。もちろん飛騨越と銘を打った日には、七里に一軒十里に五軒という相場、そこで粟の飯にありつけば都合も上の方ということになっております。
[p]
それを覚悟のことで、足は相応に達者、いや屈せずに進んだ進んだ。すると、だんだんまた山が両方から逼って来て、肩に支えそうな狭いとこになった、すぐに上。
[p]
...
[p]
両方の叢に尾と頭とを突込んで、のたりと橋を渡しているではあるまいか。
[p]
...
[p]
今度は蛇のかわりに蟹が歩きそうで草鞋が冷えた。しばらくすると暗くなった、杉、松、榎と処々見分けが出来るばかりに遠い処から幽に日の光の射すあたりでは、土の色が皆黒い。
[p]
...
[p]
どの道死ぬるものなら一足でも前へ進んで、世間の者が夢にも知らぬ血と泥の大沼の片端でも見ておこうと、そう覚悟がきまっては気味の悪いも何もあったものじゃない、体中珠数生になったのを手当次第に掻い除け※(「てへん＋劣」、第3水準1-84-77)り棄て、抜き取りなどして、手を挙げ足を踏んで、まるで躍り狂う形で歩行き出した。
[p]
...
[p]
皮ばかりの死骸は森の中の暗い処、おまけに意地の汚い下司な動物が骨までしゃぶろうと何百という数でのしかかっていた日には、酢をぶちまけても分る気遣はあるまい。
[p]
...
[p]
馬が居るようではともかくも人里に縁があると、これがために気が勇んで、ええやっと今一揉。
[p]
...
[p]
私は驚いた、こっちの生命に別条はないが、先方様の形相。いや、大別条。
[p]
（ちょいとお願い申します。）
[p]
...
[p]
（いえもう何でございます、実はこの先一町行け、そうすれば上段の室に寝かして一晩扇いでいてそれで功徳のためにする家があると承りましても、全くのところ一足も歩行けますのではございません、どこの物置でも馬小屋の隅でもよいのでございますから後生でございます。
[p]
）とさっき馬が嘶いたのは此家より外にはないと思ったから言った。
[p]
婦人はしばらく考えていたが、ふと傍を向いて布の袋を取って、膝のあたりに置いた桶の中へざらざらと一幅、水を溢すようにあけて縁をおさえて、手で掬って俯向いて見たが、
[p]
（ああ、お泊め申しましょう、ちょうど炊いてあげますほどお米もございますから、それに夏のことで、山家は冷えましても夜のものにご不自由もござんすまい。
[p]
さあ、ともかくもあなた、お上り遊ばして。）
[p]
...
[p]
（何にしても貴僧には叔母さんくらいな年紀ですよ。まあ、お早くいらっしゃい、草履もようござんすけれど、刺がささりますといけません、それにじくじく湿れていてお気味が悪うございましょうから。
[p]
）と向う向でいいながら衣服の片褄をぐいとあげた。真白なのが暗まぎれ、歩行くと霜が消えて行くような。
[p]
...
[p]
向う岸はまた一座の山の裾で、頂の方は真暗だが、山の端からその山腹を射る月の光に照し出された辺からは大石小石、栄螺のようなの、六尺角に切出したの、剣のようなのやら、鞠の形をしたのやら、目の届く限り残らず岩で、次第に大きく水に※(「くさかんむり／（酉＋隹）／れんが」、第3水準1-91-44)ったのはただ小山のよう。」
[p]
[jump target="ch14"]
...
[p]
自分達が立った側は、かえってこっちの山の裾が水に迫って、ちょうど切穴の形になって、そこへこの石を嵌めたような誂。
[p]
...
[p]
その滝が荒れましたと申しまして、ちょうど今から十三年前、恐しい洪水がございました、こんな高い処まで川の底になりましてね、麓の村も山も家も残らず流れてしまいました。
[p]
...
「婦人は驚いた顔をして、
[p]
（それでは森の中で、大変でございますこと。旅をする人が、飛騨の山では蛭が降るというのはあすこでござんす。
[p]
貴僧は抜道をご存じないから正面に蛭の巣をお通りなさいましたのでございますよ。お生命も冥加なくらい、馬でも牛でも吸い殺すのでございますもの。
[p]
...
[p]
私はそのまま目を外らしたが、その一段の婦人の姿が月を浴びて、薄い煙に包まれながら向う岸の※［＃「さんずい＋散」、U+6F75、140-10］に濡れて黒い、滑かな大きな石へ蒼味を帯びて透通って映るように見えた。
[p]
...
[p]
（何でも人間を乗っけられそうな馬じゃあござらぬ。お坊様は命拾いをなされたのじゃで、大人しゅうして嬢様の袖の中で、今夜は助けて貰わっしゃい。
[p]
さようならちょっくら行って参りますよ。）
[p]
（あい。）
...
[p]
（あれを、ああ、ああ、あれ。）といってきょろきょろと四辺を※(「目＋句」、第4水準2-81-91)す。
[p]
婦人はじっと瞻って、
[p]
...
[p]
（嬢様、何か存じませんが、おっしゃる通りになすったがよいではござりませんか。私にお気遣はかえって心苦しゅうござります。
[p]
）と慇懃にいうた。
[p]
婦人はまたもう一度、
...
[p]
もっともあのこれから冬になりまして山がまるで氷ってしまい、川も崕も残らず雪になりましても、貴僧が行水を遊ばしたあすこばかりは水が隠れません、そうしていきりが立ちます。
[p]
...
[p]
それでも風俗のかわった方がいらっしゃいますと、大事にしてお辞儀をすることだけは知ってでございますが、まだご挨拶をいたしませんね。
[p]
この頃は体がだるいと見えてお惰けさんになんなすったよ。いいえ、まるで愚なのではございません、何でもちゃんと心得ております。
[p]
...
天晴といいたそうな顔色で、
[p]
（貴僧、申せば何でも出来ましょうと思いますけれども、この人の病ばかりはお医者の手でもあの水でも復りませなんだ、両足が立ちませんのでございますから、何を覚えさしましても役には立ちません。
[p]
それにご覧なさいまし、お辞儀一ツいたしますさえ、あの通り大儀らしい。
[p]
ものを教えますと覚えますのにさぞ骨が折れて切のうござんしょう、体を苦しませるだけだと存じて何にもさせないで置きますから、だんだん、手を動かす働も、ものをいうことも忘れました。
[p]
それでもあの、謡が唄えますわ。二ツ三ツ今でも知っておりますよ。さあお客様に一ツお聞かせなさいましなね。）
[p]
...
[p]
（眠うなったのかい、もうお寝か。）といったが坐り直ってふと気がついたように四辺を※(「目＋句」、第4水準2-81-91)した。
[p]
...
（はい、ご厄介にあいなりまする。）
[p]
（まあ、いま宿を寝かします、おゆっくりなさいましな。戸外へは近うござんすが、夏は広い方が結句宜うございましょう、私どもは納戸へ臥せりますから、貴僧はここへお広くお寛ぎがようござんす、ちょいと待って。
[p]
...
[p]
むささびか知らぬがきッきッといって屋の棟へ、やがておよそ小山ほどあろうと気取られるのが胸を圧すほどに近いて来て、牛が鳴いた、遠くの彼方からひたひたと小刻に駈けて来るのは、二本足に草鞋を穿いた獣と思われた、いやさまざまにむらむらと家のぐるりを取巻いたようで、二十三十のものの鼻息、羽音、中には囁いているのがある。
[p]
...
[p]
殊に今朝も東雲に袂を振り切って別れようとすると、お名残惜しや、かような処にこうやって老朽ちる身の、再びお目にはかかられまい、いささ小川の水になりとも、どこぞで白桃の花が流れるのをご覧になったら、私の体が谷川に沈んで、ちぎれちぎれになったことと思え、といって悄れながら、
[p]
なお深切に、道はただこの谷川の流れに沿うて行きさえすれば、どれほど遠くても里に出らるる、目の下近く水が躍って、滝になって落つるのを見たら、人家が近づいたと心を安んずるように、と気をつけて、孤家の見えなくなった辺で、指しをしてくれた。
[p]
...
[p]
私は耐らず真逆に滝の中へ飛込んで、女滝をしかと抱いたとまで思った。気がつくと男滝の方はどうどうと地響打たせて。
[p]
山彦を呼んで轟いて流れている。ああその力をもってなぜ救わぬ、儘よ！
[p]
...
[p]
何んにも言わず急にものもいわれないで瞻ると、親仁はじっと顔を見たよ。そうしてにやにやと、また一通りの笑い方ではないて、薄気味の悪い北叟笑をして、
[p]
...
[p]
何と、おらが曳いて行った馬を見さしったろう。それで、孤家へ来さっしゃる山路で富山の反魂丹売に逢わしったというではないか、それみさっせい、あの助平野郎、とうに馬になって、それ馬市で銭になって、お銭が、そうらこの鯉に化けた。
[p]
大好物で晩飯の菜になさる、お嬢様を一体何じゃと思わっしゃるの）。」［＃「）。」」はママ］
[p]
私は思わず遮った。
[p]
「お上人？」
...
[p]
外科なんと来た日にゃあ、鬢附へ水を垂らしてひやりと疵につけるくらいなところ。
[p]
...
[p]
それというのが、はじまりはかの嬢様が、それ、馴染の病人には毎日顔を合せるところから愛想の一つも、あなたお手が痛みますかい、どんなでございます、といって手先へ柔かな掌が障ると第一番に次作兄いという若いのの（りょうまちす）が全快、お苦しそうなといって腹をさすってやると水あたりの差込の留まったのがある、
[p]
初手は若い男ばかりに利いたが、だんだん老人にも及ぼして、後には婦人の病人もこれで復る、復らぬまでも苦痛が薄らぐ、根太の膿を切って出すさえ、錆びた小刀で引裂く医者殿が腕前じゃ、病人は七顛八倒して悲鳴を上げるのが、娘が来て背中へぴったりと胸をあてて肩を押えていると、我慢が出来るといったようなわけであったそうな。
[p]
...
[p]
お手が障った所だけは螫しましても痛みませぬ、竹箒で引払いては八方へ散らばって体中に集られてはそれは凌げませぬ即死でございますがと、微笑んで控える手で無理に握ってもらい、つかつかと行くと、凄じい虫の唸、やがて取って返した左の手に熊蜂が七ツ八ツ、羽ばたきをするのがある、脚を振うのがある、中には掴んだ指の股へ這出しているのがあった。
[p]
...
なお親仁のいうよう。
[p]
今の白痴も、件の評判の高かった頃、医者の内へ来た病人、その頃はまだ子供、朴訥な父親が附添い、髪の長い、兄貴がおぶって山から出て来た。
[p]
...
[p]
これが引摺って、足を見ながら情なそうな顔をする。蟋蟀が※(「怨」の「心」に代えて「手」、第4水準2-13-4)がれた脚を口に銜えて泣くのを見るよう、目もあてられたものではない。
[p]
...
[p]
滝を覆すようで小歇もなく家に居ながら皆簑笠で凌いだくらい、茅葺の繕いをすることはさて置いて、表の戸もあけられず、内から内、隣同士、おうおうと声をかけ合ってわずかにまだ人種の世に尽きぬのを知るばかり、八日を八百年と雨の中に籠ると九日目の真夜中から大風が吹出してその風の勢ここが峠というところでたちまち泥海。
[p]
...
といい果てて親仁はまた気味の悪い北叟笑。
[p]
（こう身の上を話したら、嬢様を不便がって、薪を折ったり水を汲む手助けでもしてやりたいと、情が懸ろう。本来の好心、いい加減な慈悲じゃとか、情じゃとかいう名につけて、いっそ山へ帰りたかんべい、はて措かっしゃい。
[p]
...
[p]
）とまた一ツ背中を叩いた、親仁は鯉を提げたまま見向きもしないで、山路を上の方。
[p]
...
*footnotes
底本：「ちくま日本文学全集　泉鏡花」筑摩書房[r]
　　　1991（平成3）年10月20日　第1刷[r]
　　　1995（平成7）年8月15日　第2刷[r]
底本の親本：「現代日本文学大系5」筑摩書房[r]
　　　1972（昭和47）年5月15日[r]
初出：「新小説　第五年第三巻」春陽堂[r]
　　　1900（明治33）年2月1日[r]
入力：真先芳秋[r]
