...
[p]
俺はあの美しさが信じられないので、この二三日不安だった。しかしいま、やっとわかるときが来た。桜の樹の下には屍体が埋まっている。
[p]
これは信じていいことだ。
[p]
...
[p]
――おまえは何をそう苦しそうな顔をしているのだ。美しい透視術じゃないか。俺はいまようやく瞳を据えて桜の花が見られるようになったのだ。
[p]
...
[p]
おまえも知っているとおり、彼らはそこで美しい結婚をするのだ。しばらく歩いていると、俺は変なものに出喰わした。
[p]
それは溪の水が乾いた磧へ、小さい水溜を残している、その水のなかだった。思いがけない石油を流したような光彩が、一面に浮いているのだ。
[p]
おまえはそれを何だったと思う。それは何万匹とも数の知れない、薄羽かげろうの屍体だったのだ。隙間なく水の面を被っている、彼らのかさなりあった翅が、光にちぢれて油のような光彩を流しているのだ。
[p]
...
[p]
俺には惨劇が必要なんだ。その平衡があって、はじめて俺の心象は明確になって来る。俺の心は悪鬼のように憂鬱に渇いている。
[p]
...
*footnotes
底本：「檸檬・ある心の風景　他二十編」旺文社文庫、旺文社[r]
　　　1972（昭和47）年12月10日初版発行[r]
　　　1974（昭和49）年第4刷発行[r]
初出：「詩と詩論」[r]
　　　1928（昭和3）年12月[r]
※表題は底本では、「桜の樹の下には」となっています。[r]
※編集部による傍注は省略しました。[r]
入力：j.utiyama[r]
校正：earthian[r]
1998年10月10日公開[r]
